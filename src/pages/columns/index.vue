<template>
    <div class="contentbox">
        <el-form label-width="200px">
            <el-form-item label="盒子宽度" style="margin:0;">
                <el-input v-model="columnW" style="width:200px;"></el-input>
            </el-form-item>
            <el-form-item label="盒子高度" style="margin:0;">
                <el-input v-model="columnHeight" style="width:200px;"></el-input>
            </el-form-item>
            <el-form-item label="每一栏宽度column-width" style="margin:0;">
            ...
            <el-form-item label="分割线样式column-rule-style">
                <el-radio-group v-model="columnRuleStyle">
                    <el-radio :label="item" v-for="item in ruleStyleArr" :key="item">{{item}}</el-radio>
                </el-radio-group>
            </el-form-item>
            <el-form-item label="间隙宽度column-gap" style="margin:0;">
                <el-input v-model="columnGap" style="width:200px;"></el-input>
            </el-form-item>
        </el-form>
        <p>column-width优先级更高，能分栏目数的份数就分，不能分以column-width优先</p>
            <!-- 'column-rule-width': '1px', -->
        <div class="columnbox" :style="{
        ...
        <el-form label-width="200px">
            <el-form-item label="columns设置">
                <el-radio-group v-model="columnsVal">
                    <el-radio label="auto">auto</el-radio>
                    <el-radio label="2">2(栏目数)</el-radio>
                    <el-radio label="18em">18em(栏目宽度)</el-radio>
                    <el-radio label="auto 12em">auto 12em(宽度12em)</el-radio>
                    <el-radio label="auto auto">auto auto=auto</el-radio>
                </el-radio-group>
            </el-form-item>
        </el-form>
        <ul class="columnbox columnbox1" :style="{
            'width': columnW,
            'height': columnHeight,
            'columns': columnsVal}" 
            v-html="html">
...
<script>
const html = '<li><div>【荷塘月色】</div>这几天心里颇不宁静。今晚在院子里坐着乘凉，忽然想起日日走过的荷塘，在这满月的光里，总该另有一番样子吧。月亮渐渐地升高了，墙外马路上孩子们的欢笑，已经听不见了;妻在屋里拍着闰儿，迷迷糊糊地哼着眠歌。我悄悄地披了大衫，带上门出去。</li>'
...
export default {
    data () {
        return {
            ...
            ruleStyleArr : ['none','hidden','dotted','dashed','solid','double'],
            columnGap: 'normal',
        }
    },
    methods: {
